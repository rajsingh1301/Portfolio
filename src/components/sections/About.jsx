        ...
        <section className="mt-5 max-w-4xl mx-auto md:px-8" id="about">
            ...
            <div className="text-secondary-text md:flex flex-row gap-16 px-4 md:px-0" ref={ref}>
                <motion.div
                    ...
                    <p className="pb-3">
                        Hi, I'm Mayank! I'm a Computer Science student with a passion for architecting digital experiences. My journey into web development is currently centered around mastering the MERN stack (MongoDB, Express.js, React, Node.js), as I build my way toward becoming a versatile Full Stack Developer.
                    </p>
